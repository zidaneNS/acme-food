...
export default function UserInfoMobile({ user }: { user: UserDisplayType | null | undefined }) {
  ...
  return (
    <div className="block md:hidden z-10 group">
        ...
        <div className="h-[100vh] w-64 bg-white border border-slate-400 fixed -right-full duration-300 group-hover:right-0 top-0 flex flex-col justify-between gap-y-4 py-4 px-6">
            <div className="w-full flex flex-col gap-y-3 items-center text-black">
                ...
                <Link href="/home/dashboard" className={clsx(
                    "py-2 px-4 text-white hover:bg-slate-400 transition duration-300 rounded-xl w-full text-center flex gap-x-2 items-center justify-center", {
                        "bg-slate-400" : pathname === '/home/dashboard'
                    }, {
                        "bg-slate-500" : pathname !== '/home/dashboard'
                    }
                )}>
            ...
            <div className="w-full flex flex-col gap-y-3">
                ...
                <Link href="/home/about" className={clsx(
                    "py-2 px-4 text-white hover:bg-slate-400 transition duration-300 rounded-xl w-full text-center flex gap-x-2 items-center justify-center", {
                        ...
                        "bg-slate-500" : pathname !== '/home/about'
                    }
                )}>
                ...
                <Link href="/home/contact" className={clsx(
                    "py-2 px-4 text-white hover:bg-slate-400 transition duration-300 rounded-xl w-full text-center flex gap-x-2 items-center justify-center", {
                        ...
                        "bg-slate-500" : pathname !== '/home/contact'
                    }
                )}>
